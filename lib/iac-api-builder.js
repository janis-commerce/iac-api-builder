...
class IacApiBuilder {
	...
	static get sourceFilePath() {
		return path.join(process.cwd(), IAC_DIRECTORY, SRC_DIRECTORY, SOURCE_FILE);
	}

	static get resourceTemplateFilePath() {
		return path.join(process.cwd(), IAC_DIRECTORY, SRC_DIRECTORY, RESOURCE_TEMPLATE);
	}

	static get methodTemplateFilePath() {
		return path.join(process.cwd(), IAC_DIRECTORY, SRC_DIRECTORY, METHOD_TEMPLATE);
	}

	static get corsTemplateFilePath() {
		return path.join(process.cwd(), IAC_DIRECTORY, SRC_DIRECTORY, CORS_TEMPLATE);
	}
	...
	build() {
		...
		const schema = this.constructor.schemasJSON;
